...
using namespace std;
void Single_Compress(const string &in_file,
                     const string &code_file=DEF_Code_file,
                     const string &out_file=DEF_out_bfile);
void Single_Extract(const string &in_file,
                    const string &code_file=DEF_Code_file,
                    const string &out_file=DEF_out_tfile);
